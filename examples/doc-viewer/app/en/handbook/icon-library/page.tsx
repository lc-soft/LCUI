  ...
  return (
    <Widget className="doc-page">
      ...
      <Widget className="doc-section">
        <h2>Installation</h2>
        <Widget className="code-block" data-language="sh" data-source="en/handbook/icon-library/0">
      ...
      <Widget className="doc-section">
        <h2>Usage</h2>
        <Widget className="code-block" data-language="tsx" data-source="en/handbook/icon-library/1">
          <Widget className="code-block-header">
        ...
        <Widget className="code-block" data-language="tsx" data-source="en/handbook/icon-library/2">
          <Widget className="code-block-header">
            <Text className="code-block-title">TypeScript</Text>
          </Widget>
          <Widget className="code-block-body">
