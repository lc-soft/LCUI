  ...
  return (
    <Widget className="doc-page">
      ...
      <Widget className="doc-section">
        <h2>安装</h2>
        <Widget className="code-block" data-language="sh" data-source="zh-CN/handbook/icon-library/0">
      ...
      <Widget className="doc-section">
        <h2>用法</h2>
        <Widget className="code-block" data-language="tsx" data-source="zh-CN/handbook/icon-library/1">
          <Widget className="code-block-header">
        ...
        <Widget className="code-block" data-language="tsx" data-source="zh-CN/handbook/icon-library/2">
          <Widget className="code-block-header">
            <Text className="code-block-title">TypeScript</Text>
          </Widget>
          <Widget className="code-block-body">
