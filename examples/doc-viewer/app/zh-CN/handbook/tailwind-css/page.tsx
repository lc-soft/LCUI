  ...
  return (
    <Widget className="doc-page">
      ...
      <Widget className="doc-section">
        <h2>安装</h2>
        <Widget className="code-block" data-language="sh" data-source="zh-CN/handbook/tailwind-css/0">
      ...
      <Widget className="doc-section">
        ...
        <Widget className="code-block" data-language="css" data-source="zh-CN/handbook/tailwind-css/1">
          <Widget className="code-block-header">
