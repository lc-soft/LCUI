  ...
  return (
    <Widget className="doc-page">
      ...
      <Widget className="doc-section">
        ...
        <Widget className="code-block" data-language="sh" data-source="zh-CN/handbook/tsx-and-dev-tools/0">
      ...
      <Widget className="doc-section">
        <h2>用法概览</h2>
        <Widget className="code-block" data-language="tsx" data-source="zh-CN/handbook/tsx-and-dev-tools/1">
          <Widget className="code-block-header">
      ...
      <Widget className="doc-section">
        ...
        <p>{`安装方法：`}</p>
        <Widget className="code-block" data-language="sh" data-source="zh-CN/handbook/tsx-and-dev-tools/2">
          <Widget className="code-block-header">
            <Text className="code-block-title">Shell</Text>
          </Widget>
          <Widget className="code-block-body">
        ...
        <Widget className="code-block" data-language="tsx" data-source="zh-CN/handbook/tsx-and-dev-tools/3">
          <Widget className="code-block-header">
        ...
        <Widget className="code-block" data-language="c" data-source="zh-CN/handbook/tsx-and-dev-tools/4">
          <Widget className="code-block-header">
        ...
        <Widget className="code-block" data-language="tsx" data-source="zh-CN/handbook/tsx-and-dev-tools/5">
          <Widget className="code-block-header">
            <Text className="code-block-title">TypeScript</Text>
          </Widget>
          <Widget className="code-block-body">
        ...
        <p>{`之后在 C 代码中操作它：`}</p>
        <Widget className="code-block" data-language="c" data-source="zh-CN/handbook/tsx-and-dev-tools/6">
          <Widget className="code-block-header">
            <Text className="code-block-title">C</Text>
          </Widget>
          <Widget className="code-block-body">
        ...
        <Widget className="code-block" data-language="tsx" data-source="zh-CN/handbook/tsx-and-dev-tools/7">
          <Widget className="code-block-header">
            <Text className="code-block-title">TypeScript</Text>
          </Widget>
          <Widget className="code-block-body">
        ...
        <Widget className="code-block" data-language="tsx" data-source="zh-CN/handbook/tsx-and-dev-tools/8">
          <Widget className="code-block-header">
            <Text className="code-block-title">TypeScript</Text>
          </Widget>
          <Widget className="code-block-body">
        ...
        <Widget className="code-block" data-language="tsx" data-source="zh-CN/handbook/tsx-and-dev-tools/9">
          <Widget className="code-block-header">
            <Text className="code-block-title">TypeScript</Text>
          </Widget>
          <Widget className="code-block-body">
        ...
        <Widget className="code-block" data-language="c" data-source="zh-CN/handbook/tsx-and-dev-tools/10">
          <Widget className="code-block-header">
            <Text className="code-block-title">C</Text>
          </Widget>
          <Widget className="code-block-body">
        ...
        <Widget className="code-block" data-language="tsx" data-source="zh-CN/handbook/tsx-and-dev-tools/11">
          <Widget className="code-block-header">
            <Text className="code-block-title">TypeScript</Text>
          </Widget>
          <Widget className="code-block-body">
