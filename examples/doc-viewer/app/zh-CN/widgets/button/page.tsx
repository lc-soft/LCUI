  ...
  return (
    <Widget className="doc-page">
      ...
      <Widget className="doc-section">
        ...
        <Widget className="code-block" data-language="tsx" data-source="zh-CN/widgets/button/1">
          <Widget className="code-block-header">
            <Text className="code-block-title">TypeScript</Text>
          </Widget>
          <Widget className="code-block-body">
      ...
      <Widget className="doc-section">
        <h2>组合</h2>
        <p>{`使用以下组合来构建 [bgcolor=#eee] Button [/bgcolor]：`}</p>
        <Widget className="code-block" data-language="text" data-source="zh-CN/widgets/button/2">
          <Widget className="code-block-header">
