  ...
  return (
    <DemoProvider>
      ...
      <Widget className="code-block">
        ...
        <Widget className="code-block-body" data-language="xml" data-file="main.c" data-source="examples/text-basic/8" style={{ display: "none" }}>
          <CodeBlockCopy />
          <Text className="code-line">{`[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI.h>[/color][/color]`}</Text>
          <Text className="code-line">{`[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI/widgets.h>[/color][/color]`}</Text>
        ...
        <Widget className="code-block-body" data-language="xml" data-file="ui.xml" data-source="examples/text-basic/9" style={{ display: "none" }}>
          <CodeBlockCopy />
