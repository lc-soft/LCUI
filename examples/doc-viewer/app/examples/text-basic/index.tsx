  ...
  return (
    <DemoProvider>
      ...
      <Widget className="code-block">
        ...
        <Widget className="code-block-body active" data-language="tsx" data-file="example.tsx" data-source="examples/text-basic/5">
          <CodeBlockCopy />
          ...
          <Text className="code-line">{`  [color=#cf222e]return[/color] [color=#116329]<[color=#0550ae]Text[/color]>[/color]Hello, LCUI![color=#116329]</[color=#0550ae]Text[/color]>[/color];`}</Text>
          <Text className="code-line">{`}`}</Text>
        </Widget>
        <Widget className="code-block-body" data-language="tsx" data-file="main.c" data-source="examples/text-basic/6" style={{ display: "none" }}>
          <CodeBlockCopy />
        ...
        <Widget className="code-block-body" data-language="c" data-file="main.c" data-source="examples/text-basic/7" style={{ display: "none" }}>
          <CodeBlockCopy />
          <Text className="code-line">{`[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI.h>[/color][/color]`}</Text>
          <Text className="code-line">{` `}</Text>
          <Text className="code-line">{`[color=#953800]void[/color] [color=#8250df]text_basic_init[/color][color=#0550ae]([color=#953800]ui_widget_t[/color] *parent)[/color]`}</Text>
          <Text className="code-line">{`{`}</Text>
          <Text className="code-line">{`        [color=#953800]ui_widget_t[/color] *w;`}</Text>
          <Text className="code-line">{` `}</Text>
          <Text className="code-line">{`        w = ui_create_widget([color=#0a3069]"text"[/color]);`}</Text>
          <Text className="code-line">{`        ui_text_set_content(w, [color=#0a3069]"Hello, LCUI!"[/color]);`}</Text>
          <Text className="code-line">{`        ui_widget_append(parent, w);`}</Text>
          <Text className="code-line">{`}`}</Text>
        </Widget>
        <Widget className="code-block-body" data-language="xml" data-file="ui.xml" data-source="examples/text-basic/8" style={{ display: "none" }}>
          <CodeBlockCopy />
          ...
          <Text className="code-line">{`    [color=#116329]<[color=#0550ae]text[/color]>[/color]Hello, LCUI![color=#116329]</[color=#0550ae]text[/color]>[/color]`}</Text>
          <Text className="code-line">{`  [color=#116329]</[color=#0550ae]ui[/color]>[/color]`}</Text>
          <Text className="code-line">{`[color=#116329]</[color=#0550ae]lcui-app[/color]>[/color]`}</Text>
        </Widget>
        <Widget className="code-block-body" data-language="xml" data-file="main.c" data-source="examples/text-basic/9" style={{ display: "none" }}>
          <CodeBlockCopy />
          <Text className="code-line">{`[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI.h>[/color][/color]`}</Text>
