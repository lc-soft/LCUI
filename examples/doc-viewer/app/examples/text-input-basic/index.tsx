  ...
  return (
    <DemoProvider>
      ...
      <Widget className="code-block">
        ...
        <Widget className="code-block-body active" data-language="tsx" data-file="example.tsx" data-source="examples/text-input-basic/5">
          <CodeBlockCopy />
          ...
          <Text className="code-line">{`  [color=#cf222e]return[/color] [color=#116329]<[color=#0550ae]TextInput[/color] [color=#0550ae]placeholder[/color]=[color=#0a3069]"请输入..."[/color] />[/color];`}</Text>
          <Text className="code-line">{`}`}</Text>
        </Widget>
        ...
        <Widget className="code-block-body" data-language="c" data-file="main.c" data-source="examples/text-input-basic/7" style={{ display: "none" }}>
          <CodeBlockCopy />
          <Text className="code-line">{`﻿[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI.h>[/color][/color]`}</Text>
          <Text className="code-line">{` `}</Text>
          <Text className="code-line">{`[color=#953800]void[/color] [color=#8250df]text_input_basic_init[/color][color=#0550ae]([color=#953800]ui_widget_t[/color] *parent)[/color]`}</Text>
          <Text className="code-line">{`{`}</Text>
          <Text className="code-line">{`        [color=#953800]ui_widget_t[/color] *w;`}</Text>
          <Text className="code-line">{` `}</Text>
          <Text className="code-line">{`        w = ui_create_widget([color=#0a3069]"textinput"[/color]);`}</Text>
          <Text className="code-line">{`        ui_textinput_set_placeholder(w, [color=#0a3069]u8"请输入..."[/color]);`}</Text>
