  ...
  return (
    <DemoProvider>
      ...
      <Widget className="code-block">
        ...
        <Widget className="code-block-body active" data-language="tsx" data-file="example.tsx" data-source="examples/button-basic/5">
          <CodeBlockCopy />
          ...
          <Text className="code-line">{`  [color=#cf222e]return[/color] [color=#116329]<[color=#0550ae]Button[/color]>[/color]Click me[color=#116329]</[color=#0550ae]Button[/color]>[/color];`}</Text>
          <Text className="code-line">{`}`}</Text>
        </Widget>
        <Widget className="code-block-body" data-language="tsx" data-file="main.c" data-source="examples/button-basic/6" style={{ display: "none" }}>
          <CodeBlockCopy />
        ...
        <Widget className="code-block-body" data-language="c" data-file="main.c" data-source="examples/button-basic/7" style={{ display: "none" }}>
          <CodeBlockCopy />
          <Text className="code-line">{`[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI.h>[/color][/color]`}</Text>
          <Text className="code-line">{`[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI/widgets.h>[/color][/color]`}</Text>
          <Text className="code-line">{` `}</Text>
          <Text className="code-line">{`[color=#953800]void[/color] [color=#8250df]button_basic_init[/color][color=#0550ae]([color=#953800]ui_widget_t[/color] *parent)[/color]`}</Text>
          <Text className="code-line">{`{`}</Text>
          <Text className="code-line">{`        [color=#953800]ui_widget_t[/color] *btn;`}</Text>
          <Text className="code-line">{` `}</Text>
          <Text className="code-line">{`        btn = ui_create_widget([color=#0a3069]"button"[/color]);`}</Text>
          <Text className="code-line">{`        ui_button_set_text(btn, [color=#0a3069]"Click me"[/color]);`}</Text>
          <Text className="code-line">{`        ui_widget_append(parent, btn);`}</Text>
          <Text className="code-line">{`}`}</Text>
        </Widget>
        <Widget className="code-block-body" data-language="xml" data-file="main.c" data-source="examples/button-basic/8" style={{ display: "none" }}>
          <CodeBlockCopy />
          <Text className="code-line">{`[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI.h>[/color][/color]`}</Text>
          <Text className="code-line">{`[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI/widgets.h>[/color][/color]`}</Text>
        ...
        <Widget className="code-block-body" data-language="xml" data-file="ui.xml" data-source="examples/button-basic/9" style={{ display: "none" }}>
          <CodeBlockCopy />
          ...
          <Text className="code-line">{`    [color=#116329]<[color=#0550ae]button[/color]>[/color]Click me[color=#116329]</[color=#0550ae]button[/color]>[/color]`}</Text>
          <Text className="code-line">{`  [color=#116329]</[color=#0550ae]ui[/color]>[/color]`}</Text>
          <Text className="code-line">{`[color=#116329]</[color=#0550ae]lcui-app[/color]>[/color]`}</Text>
        </Widget>
      </Widget>
