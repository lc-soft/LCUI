  ...
  return (
    <DemoProvider>
      ...
      <Widget className="code-block">
        ...
        <Widget className="code-block-body active" data-language="tsx" data-file="example.tsx" data-source="examples/anchor-basic/5">
          <CodeBlockCopy />
          ...
          <Text className="code-line">{`    [color=#116329]<[color=#0550ae]a[/color] [color=#0550ae]href[/color]=[color=#0a3069]"https://lcui.dev"[/color]>[/color]LCUI Homepage[color=#116329]</[color=#0550ae]a[/color]>[/color]`}</Text>
          <Text className="code-line">{`  );`}</Text>
          <Text className="code-line">{`}`}</Text>
        </Widget>
        <Widget className="code-block-body" data-language="tsx" data-file="main.c" data-source="examples/anchor-basic/6" style={{ display: "none" }}>
          <CodeBlockCopy />
        ...
        <Widget className="code-block-body" data-language="c" data-file="main.c" data-source="examples/anchor-basic/7" style={{ display: "none" }}>
          <CodeBlockCopy />
          <Text className="code-line">{`[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI.h>[/color][/color]`}</Text>
          <Text className="code-line">{` `}</Text>
          <Text className="code-line">{`[color=#953800]void[/color] [color=#8250df]anchor_basic_init[/color][color=#0550ae]([color=#953800]ui_widget_t[/color] *parent)[/color]`}</Text>
          <Text className="code-line">{`{`}</Text>
          <Text className="code-line">{`        [color=#953800]ui_widget_t[/color] *a;`}</Text>
          <Text className="code-line">{` `}</Text>
          <Text className="code-line">{`        a = ui_create_widget([color=#0a3069]"a"[/color]);`}</Text>
          <Text className="code-line">{`        ui_text_set_content(a, [color=#0a3069]"LCUI Homepage"[/color]);`}</Text>
          <Text className="code-line">{`        ui_widget_set_attr(a, [color=#0a3069]"href"[/color], [color=#0a3069]"https://lcui.dev"[/color]);`}</Text>
          <Text className="code-line">{`        ui_widget_append(parent, a);`}</Text>
          <Text className="code-line">{`}`}</Text>
        </Widget>
        <Widget className="code-block-body" data-language="xml" data-file="main.c" data-source="examples/anchor-basic/8" style={{ display: "none" }}>
          <CodeBlockCopy />
          <Text className="code-line">{`[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI.h>[/color][/color]`}</Text>
          <Text className="code-line">{`[color=#6e7781]#[color=#cf222e]include[/color] [color=#0a3069]<LCUI/widgets.h>[/color][/color]`}</Text>
        ...
        <Widget className="code-block-body" data-language="xml" data-file="ui.xml" data-source="examples/anchor-basic/9" style={{ display: "none" }}>
          <CodeBlockCopy />
          ...
          <Text className="code-line">{`    [color=#116329]<[color=#0550ae]a[/color] [color=#0550ae]href[/color]=[color=#0a3069]"https://lcui.lc-soft.io"[/color]>[/color]Open LCUI Homepage[color=#116329]</[color=#0550ae]a[/color]>[/color]`}</Text>
          <Text className="code-line">{`  [color=#116329]</[color=#0550ae]ui[/color]>[/color]`}</Text>
          <Text className="code-line">{`[color=#116329]</[color=#0550ae]lcui-app[/color]>[/color]`}</Text>
        </Widget>
      </Widget>
