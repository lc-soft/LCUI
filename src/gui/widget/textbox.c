...
static void TextBox_ExecUpdateStyle( LCUI_Widget widget )
{
	...
	if( Widget_GetGlobalFocus( widget ) ) {
		border = Border( 1, BORDER_SOLID, RGB(55,123,203) );
