...
{
        pd_color_t color;
        unsigned char *p = (unsigned char *)pd_canvas_pixel_at(canvas, x, y);
...
PD_PUBLIC int pd_canvas_mix(pd_canvas_t *back, const pd_canvas_t *fore,
...
PD_PUBLIC int pd_canvas_horiz_flip(const pd_canvas_t *canvas,
                                   pd_canvas_t *buff);
