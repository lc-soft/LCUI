...
target("pandagl-tests")
    ...
    add_files("tests/main.c", "tests/test_canvas_mix.c", "tests/test_image_reader.c", "tests/test_font_load.c", "tests/test_text_edit.c", "tests/test_font_cache.c", "tests/test_text_baseline.c", "tests/test_text_style_tag.c")
