...
LIBROUTER_PUBLIC const router_route_record_t *router_route_get_matched_record(
    const router_route_t *route, size_t index);

LIBROUTER_PUBLIC const char *router_route_get_full_path(
    const router_route_t *route);

LIBROUTER_PUBLIC const char *router_route_get_path(const router_route_t *route);

LIBROUTER_PUBLIC const char *router_route_get_hash(const router_route_t *route);

LIBROUTER_PUBLIC const char *router_route_get_param(const router_route_t *route,
                                                    const char *key);

LIBROUTER_PUBLIC const char *router_route_get_query(const router_route_t *route,
                                                    const char *key);
