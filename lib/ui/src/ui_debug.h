...
#define UI_DEBUG_MSG(FMT, ...)                         \
        logger_log(LOGGER_LEVEL_DEBUG, "%*s" FMT "\n", \
                   ui_debug_msg_indent * 4, "", ##__VA_ARGS__)

#define UI_DEBUG_INDENT_INC ++ui_debug_msg_indent
#define UI_DEBUG_INDENT_DEC --ui_debug_msg_indent
...
#define UI_DEBUG_MSG(FMT, ...)
#define UI_DEBUG_INDENT_INC
#define UI_DEBUG_INDENT_DEC
