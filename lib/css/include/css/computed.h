...
LIBCSS_PUBLIC uint8_t css_computed_vertical_align(const css_computed_style_t *s);
...
LIBCSS_PUBLIC uint8_t css_computed_border_top_style(const css_computed_style_t *s);

LIBCSS_PUBLIC uint8_t css_computed_border_right_style(const css_computed_style_t *s);

LIBCSS_PUBLIC uint8_t
css_computed_border_bottom_style(const css_computed_style_t *s);

LIBCSS_PUBLIC uint8_t css_computed_border_left_style(const css_computed_style_t *s);

LIBCSS_PUBLIC uint8_t css_computed_border_top_color(const css_computed_style_t *s,
					       css_color_value_t *value);

LIBCSS_PUBLIC uint8_t css_computed_border_right_color(const css_computed_style_t *s,
						 css_color_value_t *value);

LIBCSS_PUBLIC uint8_t css_computed_border_bottom_color(const css_computed_style_t *s,
						  css_color_value_t *value);

LIBCSS_PUBLIC uint8_t css_computed_border_left_color(const css_computed_style_t *s,
						css_color_value_t *value);
...
LIBCSS_PUBLIC uint8_t css_computed_background_width(const css_computed_style_t *s,
					       css_numeric_value_t *value,
					       css_unit_t *unit);

LIBCSS_PUBLIC uint8_t css_computed_background_height(const css_computed_style_t *s,
						css_numeric_value_t *value,
						css_unit_t *unit);

LIBCSS_PUBLIC uint8_t css_computed_background_image(const css_computed_style_t *s,
...
LIBCSS_PUBLIC uint8_t css_computed_box_shadow_blur(const css_computed_style_t *s,
					      css_numeric_value_t *value,
					      css_unit_t *unit);

LIBCSS_PUBLIC uint8_t css_computed_box_shadow_spread(const css_computed_style_t *s,
						css_numeric_value_t *value,
						css_unit_t *unit);

LIBCSS_PUBLIC uint8_t css_computed_box_shadow_color(const css_computed_style_t *s,
					       css_color_value_t *value);
...
LIBCSS_PUBLIC void css_compute_absolute_values(const css_computed_style_t *parent,
