...
LIBCSS_INLINE css_color_value_t css_color(uint8_t a, uint8_t r, uint8_t g,
                                          uint8_t b)
{
...
LIBCSS_PUBLIC unsigned css_array_value_get_length(
    const css_style_array_value_t val);
...
LIBCSS_PUBLIC size_t css_style_value_to_string(const css_style_value_t *s,
