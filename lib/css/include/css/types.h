...
typedef enum { CSS_GAP_INHERIT, CSS_GAP_SET, CSS_GAP_NORMAL } css_gap_t;
...
typedef enum css_keyword_value_t {
        ...
        CSS_KEYWORD_MAX_CONTENT,
        CSS_KEYWORD_MIN_CONTENT,
        CSS_KEYWORD_FIT_CONTENT,
} css_keyword_value_t;
...
typedef struct css_computed_style {
        ...
        struct css_unit_bits {
                ...
                css_unit_t row_gap : 4;
                css_unit_t column_gap : 4;
        } unit_bits;
        ...
        css_numeric_value_t row_gap;
        css_numeric_value_t column_gap;
