...
static void test_css_valdef_string(const css_valdef_t *valdef)
{
        ...
        ctest_equal_bool("match('auto')",
                         css_parse_value(valdef, "auto", &val) > 0, 1);
        css_style_value_destroy(&val);
}
...
static void test_css_valdef_color(const css_valdef_t *valdef)
{
        ...
        ctest_equal_uint("match('#fff')", (int)color,
                         (int)css_color(255, 255, 255, 255));
        ...
        ctest_equal_uint("match('#ffffff')", color,
                         css_color(255, 255, 255, 255));
...
static void test_css_valdef_none(const css_valdef_t *valdef)
{
        ...
        ctest_equal_bool("notMatch('auto')",
                         css_parse_value(valdef, "auto", &val) <= 0, 1);
        css_style_value_destroy(&val);
}
...
static void test_css_valdef_none_or_auto(const css_valdef_t *valdef)
{
        ...
        ctest_equal_bool("notMatch('normal')",
                         css_parse_value(valdef, "normal", &val) <= 0, 1);
        css_style_value_destroy(&val);
}
...
void test_css_value(void)
{
        ...
        test_css_valdef("<bg-position>", test_css_valdef_background_position);
        css_destroy();
}
