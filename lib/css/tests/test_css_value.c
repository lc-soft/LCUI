...
static void test_css_valdef_string(const css_valdef_t *valdef)
{
	...
	ctest_euqal_bool("match('\"abc\"')", ret, 1);
	ctest_euqal_bool("match('auto')", css_parse_value(valdef, "auto", &val) > 0, 1);
	css_style_value_destroy(&val);
}
...
static void test_css_valdef_color(const css_valdef_t *valdef)
{
	...
	ctest_euqal_uint("match('#fff')", (int)color, (int)css_color(255, 255, 255, 255));
	...
	ctest_euqal_uint("match('#ffffff')", color, css_color(255, 255, 255, 255));
	...
	ctest_euqal_uint("match('transparent')", color, CSS_COLOR_TRANSPARENT);
	...
	ctest_euqal_uint("match('rgb(100, 200, 255)')", color,
	...
	ctest_euqal_uint("match('rgba(100, 200, 255, 0.5)')", color,
...
static void test_css_valdef_none(const css_valdef_t *valdef)
{
	...
	css_style_value_destroy(&val);
	ctest_euqal_bool("match('none')", ret, 1);
	ctest_euqal_bool("notMatch('auto')", css_parse_value(valdef, "auto", &val) <= 0, 1);
	css_style_value_destroy(&val);
}
...
static void test_css_valdef_none_or_auto(const css_valdef_t *valdef)
{
	...
	ret = css_parse_value(valdef, "auto", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE;
	ctest_euqal_bool("match('auto')", ret, 1);
	ctest_euqal_bool("notMatch('normal')", css_parse_value(valdef, "normal", &val) <= 0,
	     1);
	css_style_value_destroy(&val);
}
...
static void test_css_valdef_border(const css_valdef_t *valdef)
{
	...
	ctest_euqal_bool("match('1px solid #eee')",
	     css_parse_value(valdef, "1px solid #eee", &val) > 0, 1);
	css_style_value_destroy(&val);

	ctest_euqal_bool("match('#eee 1px solid')",
	     css_parse_value(valdef, "#eee 1px solid", &val) > 0, 1);
	css_style_value_destroy(&val);

	ctest_euqal_bool("match('solid #eee 1px')",
	...
	ctest_euqal_bool("match('1px')", ret, 1);
	css_style_value_destroy(&val);
...
static void test_css_valdef_border_2(const css_valdef_t *valdef)
{
	...
	ret = css_parse_value(valdef, "1px", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE;
	ctest_euqal_bool("notMatch('1px')", ret, 0);
	css_style_value_destroy(&val);

	ret = css_parse_value(valdef, "solid", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE;
	ctest_euqal_bool("notMatch('solid')", ret, 0);
	css_style_value_destroy(&val);

	ret = css_parse_value(valdef, "#eee", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE;
	ctest_euqal_bool("notMatch('#eee')", ret, 0);
	css_style_value_destroy(&val);
}
...
static void test_css_valdef_length_2(const css_valdef_t *valdef)
{
	...
	ret = css_parse_value(valdef, "1px 2px", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE &&
	      css_style_value_get_array_length(&val) == 2;
	ctest_euqal_bool("match('1px 2px')", ret, 1);
	css_style_value_destroy(&val);

	ret = css_parse_value(valdef, "1px", &val) != 0;
	ctest_euqal_bool("notMatch('1px')", ret, 1);
	css_style_value_destroy(&val);
}
...
static void test_css_valdef_length_1_4(const css_valdef_t *valdef)
{
	...
	ctest_euqal_bool("notMatch('')", ret, 1);
	css_style_value_destroy(&val);
	...
	ret = css_parse_value(valdef, "1px 2px 3px", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE &&
	      css_style_value_get_array_length(&val) == 3;
	ctest_euqal_bool("match('1px 2px 3px')", ret, 1);
	css_style_value_destroy(&val);

	ret = css_parse_value(valdef, "1px 2px 3px 4px", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE &&
	      css_style_value_get_array_length(&val) == 4;
	ctest_euqal_bool("match('1px 2px 3px 4px')", ret, 1);
	css_style_value_destroy(&val);

	ret = css_parse_value(valdef, "1px 2px 3px 4px 5px", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE &&
	      css_style_value_get_array_length(&val) == 4;
	ctest_euqal_bool("Match('1px 2px 3px 4px 5px')", ret, 1);
	css_style_value_destroy(&val);
}
...
static void test_css_valdef_length_percentage_1_4(const css_valdef_t *valdef)
{
	...
	ret = css_parse_value(valdef, "1px", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE &&
	      css_style_value_get_array_length(&val) == 1;
	ctest_euqal_bool("match('50%')", ret, 1);
	css_style_value_destroy(&val);
	...
	ret = css_parse_value(valdef, "1px 2px", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE &&
	      css_style_value_get_array_length(&val) == 2;
	ctest_euqal_bool("match('50% 50%')", ret, 1);
	css_style_value_destroy(&val);
	...
	ret = css_parse_value(valdef, "1px 2px 3px", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE &&
	      css_style_value_get_array_length(&val) == 3;
	ctest_euqal_bool("match('50% 50% 50%')", ret, 1);
	css_style_value_destroy(&val);
	...
	ret = css_parse_value(valdef, "1px 2px 3px 4px", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE &&
	      css_style_value_get_array_length(&val) == 4;
	ctest_euqal_bool("match('50% 50% 50% 50%')", ret, 1);
	css_style_value_destroy(&val);
...
static void test_css_valdef_background_position(const css_valdef_t *valdef)
{
	...
	ret = css_parse_value(valdef, "center", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE &&
	      css_style_value_get_array_length(&val) == 1;
	ctest_euqal_bool("match('center')", ret, 1);
	css_style_value_destroy(&val);

	ret = css_parse_value(valdef, "10px", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE &&
	      css_style_value_get_array_length(&val) == 1;
	ctest_euqal_bool("match('10px')", ret, 1);
	css_style_value_destroy(&val);
	...
	ctest_euqal_bool("match('top center')", ret, 1);
	css_style_value_destroy(&val);

	ret = css_parse_value(valdef, "bottom 10px right 20px", &val) > 0 &&
	      val.type == CSS_ARRAY_VALUE &&
	      css_style_value_get_array_length(&val) == 4;
	ctest_euqal_bool("match('bottom 10px right 20px')", ret, 1);
	css_style_value_destroy(&val);
}
			    ...
			    void (*func)(const css_valdef_t *))
{
	...
	if (valdef) {
		...
		ctest_euqal_bool("should be able to parse", 0, 1);
	}
	ctest_group_end();
	ctest_printf("\n");
