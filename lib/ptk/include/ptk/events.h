...
PTK_PUBLIC int ptk_add_event_listener(int event_type,
                                      ptk_event_handler_t handler, void *data);
PTK_PUBLIC int ptk_remove_event_listener(int event_type,
                                         ptk_event_handler_t handler);

PTK_INLINE int ptk_on_event(int event_type, ptk_event_handler_t handler,
                            void *data)
{
