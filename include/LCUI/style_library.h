...
struct LCUI_ObjectRec_ {
	char *id;		/**< 元素的ID */
	char *name;		/**< 元素名称 */
	char **classes;		/**< 元素拥有的类列表 */
	char **pseudo_classes;	/**< 元素拥有的伪类列表 */
	LCUI_Object parent;	/**< 父元素的选择器 */
};
...
/** 匹配元素路径与样式结点路径 */
LCUI_API LCUI_BOOL IsMatchPath( LCUI_Object *obj_path, LCUI_Selector selector );

/** 添加样式表 */
LCUI_API int LCUI_PutStyle( LCUI_Selector selector, LCUI_StyleSheet in_ss );

/** 获取样式表 */
LCUI_API int LCUI_GetStyle( LCUI_Object obj, LCUI_StyleSheet out_ss );
