...
static void test_flex_layout_with_content_width(float width)
{
	...
	ctest_euqal_ui_rect("$('.example')[7].border_box", &w->border_box, &rect);

	rect.y += rect.height + 10;
	rect.height = 204;
	w = ui_widget_get_child(container, 8);
	ctest_euqal_ui_rect("$('.example')[8].border_box", &w->border_box, &rect);

	rect.y += rect.height + 10;
	rect.height = 354;
	w = ui_widget_get_child(container, 9);
	ctest_euqal_ui_rect("$('.example')[9].border_box", &w->border_box, &rect);

	rect.y += rect.height + 10;
	rect.height = 354;
	w = ui_widget_get_child(container, 10);
	ctest_euqal_ui_rect("$('.example')[10].border_box", &w->border_box, &rect);

	rect.y += rect.height + 10;
	rect.height = 354;
	w = ui_widget_get_child(container, 11);
	ctest_euqal_ui_rect("$('.example')[11].border_box", &w->border_box, &rect);

	rect.y += rect.height + 10;
	rect.height = 354;
	w = ui_widget_get_child(container, 12);
	ctest_euqal_ui_rect("$('.example')[12].border_box", &w->border_box, &rect);

	rect.y += rect.height + 10;
	rect.height = 354;
	w = ui_widget_get_child(container, 13);
	ctest_euqal_ui_rect("$('.example')[13].border_box", &w->border_box, &rect);

	rect.y += rect.height + 10;
	rect.height = 254;
	w = ui_widget_get_child(container, 14);
	ctest_euqal_ui_rect("$('.example')[14].border_box", &w->border_box, &rect);

	rect.y += rect.height + 10;
	rect.height = 185;
	w = ui_widget_get_child(container, 15);
	ctest_euqal_ui_rect("$('.example')[15].border_box", &w->border_box, &rect);

	rect.y += rect.height + 10;
	rect.height = 354;
	w = ui_widget_get_child(container, 16);
	ctest_euqal_ui_rect("$('.example')[16].border_box", &w->border_box, &rect);
	...
	ctest_euqal_ui_rect("$('.example:eq(2) .box')[0].border_box", &w->border_box,
		 &rect);
	...
	ctest_euqal_ui_rect("$('.example:eq(3) .box')[1].border_box", &w->border_box,
		 &rect);
	...
	ctest_euqal_ui_rect("$('.example:eq(4) .box')[0].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += 50 + (content_width - 300) / 6.f;
	ctest_euqal_ui_rect("$('.example:eq(4) .box')[1].border_box", &w->border_box,
		 &rect);

	w = ui_widget_get_child(content, 5);
	rect.x = 5 + content_width - (content_width - 300) / 6.f / 2.f - 50;
	ctest_euqal_ui_rect("$('.example:eq(4) .box')[5].border_box", &w->border_box,
		 &rect);
	...
	w = ui_widget_get_child(content, 0);
	rect.x = 5;
	ctest_euqal_ui_rect("$('.example:eq(5) .box')[0].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += 50 + (content_width - 200) / 2.f;
	ctest_euqal_ui_rect("$('.example:eq(5) .box')[1].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += 50;
	ctest_euqal_ui_rect("$('.example:eq(5) .box')[2].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += 50 + (content_width - 200) / 2.f;
	ctest_euqal_ui_rect("$('.example:eq(5) .box')[3].border_box", &w->border_box,
		 &rect);
	...
	ctest_euqal_ui_rect("$('.example:eq(7) .box')[0].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += rect.width;
	ctest_euqal_ui_rect("$('.example:eq(7) .box')[1].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += rect.width;
	ctest_euqal_ui_rect("$('.example:eq(7) .box')[2].border_box", &w->border_box,
		 &rect);
	...
	ctest_euqal_ui_rect("$('.example:eq(7) .box')[3].border_box", &w->border_box,
		 &rect);
	...
	ctest_euqal_ui_rect("$('.example:eq(7) .box')[6].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += rect.width;
	ctest_euqal_ui_rect("$('.example:eq(7) .box')[7].border_box", &w->border_box,
		 &rect);
	...
	rect.x = 5 + 50;
	ctest_euqal_ui_rect("$('.example:eq(7) .box')[10].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += rect.width;
	ctest_euqal_ui_rect("$('.example:eq(7) .box')[11].border_box", &w->border_box,
		 &rect);
	...
	ctest_euqal_ui_rect("$('.example:eq(7) .box')[12].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += rect.width;
	rect.width = 12 + (content_width - 3 * 12) * 2.f / 7.f;
	ctest_euqal_ui_rect("$('.example:eq(7) .box')[13].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += rect.width;
	rect.width = 12 + (content_width - 3 * 12) / 7.f;
	ctest_euqal_ui_rect("$('.example:eq(7) .box')[14].border_box", &w->border_box,
		 &rect);
	...
	rect.width = 50;
	ctest_euqal_ui_rect("$('.example:eq(10) .box')[0].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += 50;
	ctest_euqal_ui_rect("$('.example:eq(10) .box')[1].border_box", &w->border_box,
		 &rect);
	...
	rect.y = 5 + (300 / 3.f - 50);
	rect.width = 50;
	ctest_euqal_ui_rect("$('.example:eq(11) .box')[0].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += 50;
	ctest_euqal_ui_rect("$('.example:eq(11) .box')[1].border_box", &w->border_box,
		 &rect);
	...
	rect.width = 50;
	rect.height = 100;
	ctest_euqal_ui_rect("$('.example:eq(12) .box')[0].border_box", &w->border_box,
		 &rect);

	w = ui_widget_next(w);
	rect.x += 50;
	ctest_euqal_ui_rect("$('.example:eq(12) .box')[1].border_box", &w->border_box,
		 &rect);
	...
	rect.x = 5 + 3 * 50;
	rect.height = 50;
	ctest_euqal_ui_rect("$('.example:eq(12) .box')[3].border_box", &w->border_box,
		 &rect);
	...
	rect.width = 50;
	rect.height = 50;
	ctest_euqal_ui_rect("$('.example:eq(13) .box')[0].border_box", &w->border_box,
		 &rect);
	...
	rect.width = 50;
	rect.height = 50;
	ctest_euqal_ui_rect("$('.example:eq(14) .box')[0].border_box", &w->border_box,
		 &rect);

	w = ui_widget_get_child(content, 4);
	rect.x = 5 + 50 + (content_width - 50 - 150 - 200 - 50 - 50) / 5.f;
	rect.width = 150;
	ctest_euqal_ui_rect("$('.example:eq(14) .box')[4].border_box", &w->border_box,
		 &rect);

	w = ui_widget_get_child(content, 8);
	rect.x += 150 + (content_width - 50 - 150 - 200 - 50 - 50) / 5.f;
	rect.width = 50;
	ctest_euqal_ui_rect("$('.example:eq(14) .box')[8].border_box", &w->border_box,
		 &rect);
	...
	rect.height = 50;
	ctest_euqal_ui_rect("$('.example:eq(15) .layout__header')[0].border_box",
		 &w->border_box, &rect);

	w = ui_widget_get_child(content, 2);
	rect.y = 5 + 50 + 31;
	ctest_euqal_ui_rect("$('.example:eq(15) .layout__footer')[0].border_box",
		 &w->border_box, &rect);
	...
	ctest_euqal_ui_rect("$('.example:eq(15) .layout__left')[0].border_box",
		 &w->border_box, &rect);

	w = ui_widget_next(w);
	rect.x = 100;
	rect.width = content_width - 100 - 100;
	ctest_euqal_ui_rect("$('.example:eq(15) .layout__center')[0].border_box",
		 &w->border_box, &rect);

	w = ui_widget_next(w);
	rect.x += rect.width;
	rect.width = 100;
	ctest_euqal_ui_rect("$('.example:eq(15) .layout__right')[0].border_box",
		 &w->border_box, &rect);
	...
	rect.width = content_width;
	rect.height = 50;
	ctest_euqal_ui_rect("$('.example:eq(16) .layout__header')[0].border_box",
		 &w->border_box, &rect);

	w = ui_widget_get_child(content, 2);
	rect.y = 5 + 50 + 200;
	ctest_euqal_ui_rect("$('.example:eq(16) .layout__footer')[0].border_box",
		 &w->border_box, &rect);
	...
	w = ui_widget_get_child(content, 1);
	w = ui_widget_get_child(w, 0);
	ctest_euqal_ui_rect("$('.example:eq(16) .layout__left')[0].border_box",
		 &w->border_box, &rect);

	w = ui_widget_next(w);
	rect.x = 100;
	rect.width = content_width - 100 - 100;
	ctest_euqal_ui_rect("$('.example:eq(16) .layout__center')[0].border_box",
		 &w->border_box, &rect);

	w = ui_widget_next(w);
	rect.x += rect.width;
	rect.width = 100;
	ctest_euqal_ui_rect("$('.example:eq(16) .layout__right')[0].border_box",
		 &w->border_box, &rect);
}
...
static void test_browser_layout(void)
{
	...
	w = ui_widget_get_child(w, 0);
	ctest_euqal_int("$('#browser-tabbar .c-frame-tab')[0].width",
	     (int)w->border_box.width, 101);
	w = ui_widget_next(w);
	ctest_euqal_int("$('#browser-tabbar .c-frame-tab')[1].width",
	     (int)w->border_box.width, 101);
	w = ui_widget_next(w);
	ctest_euqal_int("$('#browser-tabbar .c-frame-tab')[2].width",
	     (int)w->border_box.width, 101);
	w = ui_widget_next(w);
	ctest_euqal_int("$('#browser-tabbar .c-frame-tab')[3].width",
	     (int)w->border_box.width, 101);
	w = ui_widget_next(w);
	ctest_euqal_int("$('#browser-tabbar .c-frame-tab')[4].width",
	     (int)w->border_box.width, 101);

	w = ui_get_widget("browser-frame-client");
	ctest_euqal_int("$('#browser-frame-client')[0].height", (int)w->border_box.height,
	     224);
	w = ui_get_widget("browser-frame-content");
	ctest_euqal_int("$('#browser-frame-content')[0].height", (int)w->border_box.height,
	     224);
	w = ui_get_widget("browser-page-home");
	ctest_euqal_int("$('#browser-page-home')[0].height", (int)w->border_box.height,
	     224);
	...
	ctest_euqal_ui_rect("$('#browser-page-home-container')[0].border_box",
		 &w->border_box, &rect);
}
