...
static widget_opacity_scene_t scene;
...
static void check_widget_opactiy(void)
{
        ...
        ui_widget_set_style_string(scene.parent, "opacity", "0.8");
        ui_widget_resize(scene.parent, 512, 256);
        ui_widget_request_refresh_style(scene.child);
        ui_widget_request_refresh_style(scene.parent);
        ui_widget_update(scene.parent);
        ui_widget_render(scene.parent, &paint);
        ...
        ctest_equal_bool("should match parent border color",
        ...
        pd_blend_pixel(&expected_color, &parent_bgcolor,
                       (int)(PARENT_OPACITY * 255));
        ctest_equal_bool("should match parent background color",
                         check_color(expected_color, color), true);
        ...
        ctest_equal_bool("should match child 1 background color",
                         check_color(expected_color, color), true);
        ...
        pd_blend_pixel(&expected_color, &tmp, (int)(PARENT_OPACITY * 255));
        ctest_equal_bool("should match child 1 footer background color",
                         check_color(expected_color, color), true);
        ...
        pd_blend_pixel(&expected_color, &child_bgcolor,
                       (int)(PARENT_OPACITY * 255));
        ctest_equal_bool("should match child 2 background color",
                         check_color(expected_color, color), true);
        expected_color = child_footer_bgcolor;
        color = pd_canvas_get_pixel(&canvas, 220, 120);
        ctest_equal_bool("should match child 2 footer background color",
                         check_color(expected_color, color), true);
...
void test_widget_opacity(void)
{
        ...
        ctest_describe("widget opacity", check_widget_opactiy);
        lcui_destroy();
}
