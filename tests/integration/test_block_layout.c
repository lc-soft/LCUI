...
static void test_dropdown(void)
{
        ...
        w = ui_widget_next(w);
        ctest_equal_int(
            "$('#test-dropdown-menu .dropdown-item')[1].border_box.width",
            (int)w->border_box.width, width);
        ctest_equal_int(
            "$('#test-dropdown-menu .dropdown-item')[1].border_box.height",
            (int)w->border_box.height, height);

        w = ui_widget_next(w);
        ctest_equal_int(
            "$('#test-dropdown-menu .dropdown-item')[2].border_box.width",
            (int)w->border_box.width, width);
        ctest_equal_int(
            "$('#test-dropdown-menu .dropdown-item')[2].border_box.height",
            (int)w->border_box.height, height);

        w = ui_widget_next(w);
        ctest_equal_int(
            "$('#test-dropdown-menu .dropdown-item')[3].border_box.width",
            (int)w->border_box.width, width);
        ctest_equal_int(
            "$('#test-dropdown-menu .dropdown-item')[3].border_box.height",
            (int)w->border_box.height, height);
}
...
static void test_auto_size(void)
{
        ...
        rect.y = 5;
        rect.width = 200;
        rect.height = 1.f * two_lines_box_height;
        ctest_equal_ui_rect("$('#test-text-auto-height')[0].border_box",
                            &w->border_box, &rect);
        ...
        ui_text_set_content_w(
            w, L"long long long long long long long long long long long long "
               ...
               L"long long text");
        ui_update();
        ctest_equal_int("$('#test-text-auto-size')[0].border_box.x",
                        (int)w->border_box.x, 5);
        ctest_equal_int("$('#test-text-auto-size')[0].border_box.y",
                        (int)w->border_box.y, 5 + two_lines_box_height);
        ...
        w = ui_widget_next(w);
        ctest_equal_int("$('#test-text-block-auto-height')[0].border_box.y",
                        (int)w->border_box.y, 5 + two_lines_box_height * 2);
...
static void test_inline_block_nesting(void)
{
        ...
        rect.height = box_height * 3.f;
        ctest_equal_ui_rect(
            "$('#example-inline-block-nesting__block-1')[0].border_box",
            &w->border_box, &rect);

        w = ui_widget_get_child(w, 1);
        rect.width /= 2.f;
        rect.height = 1.f * box_height;
        rect.x = rect.width;
        rect.y = 0;
        ctest_equal_ui_rect(
        ...
        rect.y = 5;
        ctest_equal_ui_rect(
            "$('#example-inline-block-nesting__block-2')[0].border_box",
            &w->border_box, &rect);
}
...
static void test_absolutely_positioned_progress_bar(void)
{
        ...
        ctest_equal_int("It should have the correct width",
...
static void test_block_layout_1280(void)
{
        ...
        ctest_equal_ui_rect("$('.example:eq(0) .box')[13].border_box",
                            &w->border_box, &rect);
        ...
        rect.y += 50;
        ctest_equal_ui_rect(
            "$('.example:eq(0) .box.ml-auto.mr-auto')[0].border_box",
            &w->border_box, &rect);
        ...
        w = ui_widget_next(w);
        rect.y += 50;
        ctest_equal_ui_rect("$('.example:eq(1) .box')[1].border_box",
                            &w->border_box, &rect);

        w = ui_widget_next(w);
        rect.y += 50;
        rect.width = content->content_box.width;
        ctest_equal_ui_rect("$('.example:eq(1) .box')[2].border_box",
                            &w->border_box, &rect);

        w = ui_widget_next(w);
        rect.y += 50;
        rect.width = content->content_box.width * 0.5f;
        ctest_equal_ui_rect("$('.example:eq(1) .box')[3].border_box",
                            &w->border_box, &rect);

        w = ui_widget_next(w);
        rect.x += rect.width;
        ctest_equal_ui_rect("$('.example:eq(1) .box')[4].border_box",
                            &w->border_box, &rect);
        ...
        ctest_equal_ui_rect("$('.example:eq(1) .box')[5].border_box",
                            &w->border_box, &rect);

        w = ui_widget_next(w);
        rect.x += rect.width;
        ctest_equal_ui_rect("$('.example:eq(1) .box')[6].border_box",
                            &w->border_box, &rect);

        w = ui_widget_next(w);
        rect.x += rect.width;
        ctest_equal_ui_rect("$('.example:eq(1) .box')[7].border_box",
                            &w->border_box, &rect);

        w = ui_widget_next(w);
        rect.x += rect.width;
        ctest_equal_ui_rect("$('.example:eq(1) .box')[8].border_box",
                            &w->border_box, &rect);
        ...
        rect.y += 8;
        rect.width = 150;
        ctest_equal_ui_rect("$('.example:eq(3) .box')[6].border_box",
                            &w->border_box, &rect);
        ...
        rect.y -= 8;
        rect.width = 100;
        ctest_equal_ui_rect("$('.example:eq(3 .box')[7].border_box",
                            &w->border_box, &rect);
        ...
        rect.height = 50;
        ctest_equal_ui_rect("$('.example:eq(3) .box')[8].border_box",
                            &w->border_box, &rect);
        ...
        rect.width = content->content_box.width;
        rect.height = 50;
        ctest_equal_ui_rect("$('.example:eq(3) .box')[9].border_box",
                            &w->border_box, &rect);
        ...
        ctest_equal_ui_rect("$('.example:eq(3) .box')[10].border_box",
                            &w->border_box, &rect);
        ...
        ctest_equal_ui_rect(
            "$('.example:eq(3) .box.ml--1.mr--1')[0].border_box",
            &w->border_box, &rect);
        ...
        rect.width = 200;
        ctest_equal_ui_rect(
            "$('.example:eq(3) .box.ml--1.mr--1')[1].border_box",
            &w->border_box, &rect);
        ...
        rect.width = content->content_box.width;
        ctest_equal_ui_rect(
            "$('.example:eq(3) .box.ml--1.mr--1')[2].border_box",
            &w->border_box, &rect);
        ...
        rect.width = 100;
        rect.height = 100;
        ctest_equal_ui_rect("$('#box-absolute-top-left')[0].border_box",
                            &w->border_box, &rect);

        w = ui_get_widget("box-absolute-top-right");
        rect.x = content->padding_box.width - rect.width;
        ctest_equal_ui_rect("$('#box-absolute-top-right')[0].border_box",
                            &w->border_box, &rect);
        ...
        ctest_equal_ui_rect("$('#box-absolute-center')[0].border_box",
                            &w->border_box, &rect);

        w = ui_get_widget("box-absolute-bottom-left");
        rect.x = 0;
        rect.y = content->padding_box.height - rect.height;
        ctest_equal_ui_rect("$('#box-absolute-bottom-left')[0].border_box",
                            &w->border_box, &rect);
        ...
        ctest_equal_int("$('#test-text-auto-size')[0].height",
                        (int)w->border_box.height, (int)rect.height);
        ...
        ctest_describe("auto size", test_auto_size);
        ctest_describe("dropdown", test_dropdown);
        ctest_describe("inline block nesting", test_inline_block_nesting);
        ctest_describe("absolutely positioned progress bar",
...
static void test_block_layout_600(void)
{
        ...
        ctest_equal_ui_rect("$('.example:eq(0) .box')[11].border_box",
                            &w->border_box, &rect);
        ...
        ctest_equal_ui_rect("$('.example:eq(0) .box')[14].border_box",
                            &w->border_box, &rect);
        ...
        rect.y += 50;
        ctest_equal_ui_rect("$('.example:eq(0) .box')[15].border_box",
                            &w->border_box, &rect);
        ...
        rect.width = 50;
        rect.height = 50;
        ctest_equal_ui_rect("$('.example:eq(0) .box')[26].border_box",
                            &w->border_box, &rect);
        ...
        rect.width = content->content_box.width;
        rect.height = 50;
        ctest_equal_ui_rect("$('.example:eq(3) .box')[13].border_box",
                            &w->border_box, &rect);
