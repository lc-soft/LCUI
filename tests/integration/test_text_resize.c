...
static void check_text_set_content(void)
{
        ...
        ctest_equal_float("should match block width",
                          self.block->border_box.width, 122.f);
        ctest_equal_bool("should expand block height beyond 140px",
                         self.block->border_box.height > 140.f, true);
        ctest_equal_float("should match inline block width",
                          self.inline_block->border_box.width, 580.f);
        ctest_equal_float("should match inline block height",
...
static void check_text_set_short_content_css(void)
{
        ...
        ctest_equal_float("should match block width with short content",
                          self.block->border_box.width, 122.f);
        ctest_equal_float("should match block height with short content",
                          self.block->border_box.height, 42.f);
        ctest_equal_bool("should shrink inline block width below 70px",
                         self.inline_block->border_box.width < 70.f, true);
        ctest_equal_float("should match inline block height with short content",
...
static void check_text_set_long_content_css(void)
{
        ...
        ctest_equal_float("should match block width with long content",
                          self.block->border_box.width, 122.0f);
        ctest_equal_bool("should expand block height beyond 60px",
                         self.block->border_box.height > 60.0f, true);
        ctest_equal_bool("should expand inline block width beyond 250px",
                         self.inline_block->border_box.width > 250.0f, true);
        ctest_equal_bool("should keep inline block height below 45px",
...
void test_text_resize(void)
{
        ...
        ctest_describe("text set content", check_text_set_content);
        test_text_set_short_content_css(NULL);
        ctest_describe("text set short content css",
                       check_text_set_short_content_css);
        test_text_set_long_content_css(NULL);
        ctest_describe("text set long content css",
